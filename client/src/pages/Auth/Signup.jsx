            ...
            >
                <div className="bg-white p-10 md:p-12 rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100/80">
                    <div className="flex flex-col items-center mb-10">
                        ...
                        <h2 className="text-3xl font-semibold text-[#1D1D1F] mb-3 tracking-tight">Create Account</h2>
                        <p className="text-[#86868B] font-medium text-center">Join us for a healthier lifestyle.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-[#86868B] uppercase tracking-wider ml-1">Full Name</label>
                            <div className="relative group">
                                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#86868B] group-focus-within:text-[#007AFF] transition-colors" />
                                <input
                                    type="text"
                                    required
                                    value={name}
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-[#86868B] uppercase tracking-wider ml-1">Password</label>
                            <div className="relative group">
                    ...
                    <div className="mt-10 pt-8 border-t border-gray-100 text-center">
                        <p className="text-[#86868B] text-sm font-medium">
                            Already have an account? <Link to="/auth/login" className="text-[#007AFF] font-bold hover:underline transition ml-1">Sign in</Link>
                        </p>
                    </div>
                </div>
            </motion.div>
